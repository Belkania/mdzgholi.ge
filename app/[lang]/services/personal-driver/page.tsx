...
const content: Record<string, { h1: string; description: string; benefits: string[]; faq: { q: string; a: string }[] }> = {
    ka: {
        h1: "პირადი მძღოლი",
        description: "გჭირდება პირადი მძღოლი ყოველდღიურ ცხოვრებაში? mdzgholi.ge-ი გთავაზობთ სრულ და ნახევარ განაკვეთზე პირადი მძღოლის მომსახურებას, ბიზნეს-ვიზიტებিდან ოჯახური გადაადგილების ჩათვლით.",
        benefits: [
    ...
    en: {
        ...
        description: "Need a personal driver for your daily life? mdzgholi.ge offers full-time or part-time personal driver services, from business meetings to family errands.",
        benefits: [
    ...
    ru: {
        h1: "Личный водитель",
        description: "Нужен личный водитель для повседневной жизни? mdzgholi.ge предоставляет услуги личного водителя на полную или частичную занятость — от деловых встреч до семейных поездок.",
        benefits: [
