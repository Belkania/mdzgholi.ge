...
const content: Record<string, { h1: string; description: string; benefits: string[]; faq: { q: string; a: string }[] }> = {
    ka: {
        ...
        description: "აკუმულატორი დაჯდა ან საბურავი გაგიფუჭდა? mdzgholi.ge-ის სპეციალისტი ადგილზე მოვა და პრობლემას სწრაფად მოაგვარებს. არ არის საჭირო ევაკუატორის ლოდინი — ჩვენ ადგილზე ვწყვეტთ.",
        benefits: [
    ...
    en: {
        ...
        description: "Dead battery or flat tire? mdzgholi.ge's specialist comes to your location and fixes the problem quickly. No need to wait for a tow truck — we solve it on the spot.",
        benefits: [
    ...
    ru: {
        ...
        description: "Сел аккумулятор или пробито колесо? Специалист mdzgholi.ge приедет на место и быстро решит проблему. Не нужно ждать эвакуатор — решаем на месте.",
        benefits: [
