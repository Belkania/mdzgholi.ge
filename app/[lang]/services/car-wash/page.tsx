...
const content: Record<string, { h1: string; description: string; benefits: string[]; faq: { q: string; a: string }[] }> = {
    ka: {
        h1: "მანქანის რეცხვა",
        description: "mdzgholi.ge მანქანის რეცხვის სერვისი მუშაობს მარტივად: დაგვირეკეთ, ჩვენ მოვდივართ თქვენს მისამართზე და ავტომობილს წავიყვანთ ჩვენს სარეცხ ლოკაციაზე. ვრეცხავთ შიგნიდან და გარედან იდეალურად, ხოლო შემდეგ მანქანას მივიყვანთ თქვენს მიერ მითითებულ ნებისმიერ მისამართზე. არ გჭირდება არსად წასვლა — უბრალოდ დაგვირეკეთ და ყველაფერს ჩვენ მოვაგვარებთ.",
        benefits: [
    ...
    en: {
        h1: "Car Wash Service",
        description: "mdzgholi.ge car wash works simply: call us and we come to your location, pick up your car, and take it to our washing facility. We wash it inside and out to perfection, then deliver it to any address you specify. You don't have to do a thing — just call and we handle everything.",
        benefits: [
