...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        keywords: "ფხიზელი მძღოლი, მძღოლი გამოძახებით, მძღოლის გამოძახება, ნასვამი მძღოლი, ფხიზელი მძღოლის გამოძახება, sober driver Tbilisi, mdzgholi.ge, sober driver Georgia",
        alternates: {
            canonical,
            languages: {
                ka: `${base}${path}`,
...
const content: Record<string, { h1: string; description: string; benefits: string[]; faq: { q: string; a: string }[] }> = {
    ka: {
        ...
        benefits: [
            ...
            "სწრაფი მძღოლის გამოძახება — მძღოლი გამოძახებით საშუალოდ 15-20 წუთში ჩამოდის",
        ...
        faq: [
            { q: "როგორ შეიძლება მძღოლის გამოძახება?", a: "ფხიზელი მძღოლის გამოძახება ძალიან მარტივია — დაგვიკავშირდით ნომერზე +995 568 83 47 07 ან მოგვწერეთ WhatsApp-ში. ოპერატორი გეხმაურებათ მომენტალურად და გამოგიგზავნით მძღოლს გამოძახებით." },
            { q: "მძღოლი გამოძახებით ჩაჯდება ჩემს მანქანაში?", a: "დიახ! ჩვენი სერვისის არსი სწორედ იმაშია, რომ მძღოლი გამოძახებით მართავს თქვენს ავტომობილს და მიგიყვანთ დანიშნულების ადგილამდე. მძღოლი კი ჩვენი კოლეგის მანქანით დაბრუნდება." },
            ...
            { q: "მუშაობთ ღამის 4 საათზე ან დღესასწაულებზე?", a: "დიახ, mdzgholi.ge-ს მძღოლის გამოძახება შესაძლებელია წელიწადში 365 დღე, 24 საათი. ჩვენი გუნდი მზად არის დაგეხმაროთ ნებისმიერ დროს." },
            { q: "მჭირდება თუ არა წინასწარ მძღოლის გამოძახება?", a: "წინასწარი გამოძახება სავალდებულო არ არის, თუმცა სასურველია პიკის საათებში ან სადღესასწაულო პერიოდში, რათა დაზოგოთ დრო." },
            { q: "რა მოხდება თუ მძღოლი ავარიაში მოჰყვება ჩენი მანქანით?", a: "ჩვენი ყველა მძღოლი გამოძახებით არის პროფესიონალი და პასუხისმგებელი. ნებისმიერი გაუთვალისწინებელი შემთხვევისას ჩვენ ვიღებთ პასუხისმგებლობას შეთანხმებისამებრ." },
        ],
    },
    en: {
